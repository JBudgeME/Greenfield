---
name: loop-library
description: Discover, find, audit, adapt, or design bounded, repeatable AI-agent loops with clear triggers, verification, and stopping conditions. Use to mine a codebase or thread history for repeated work worth looping, recommend a published loop, turn repeated work into a copy-ready loop, or review an existing loop for weak checks, unsafe authority, or unclear stopping.
---
