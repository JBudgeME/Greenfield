...
These are canonical role names — the actual label strings used in the issue tracker may differ. The mapping is documented at `docs/agents/triage-labels.md` — read it if not already provided.
